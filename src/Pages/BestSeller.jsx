        ...
        <div>
            <div className="hero p-12 rounded-lg bg-base-200 mb-10">
                <div className="flex flex-col items-center gap-5">
                    <h1 className="text-green-400 text-4xl font-bold">Our Best Seller Of The Month</h1>
                </div>
            </div>
            <div className="flex items-center overflow-x-auto overflow-y-hidden  flex-nowrap dark:bg-gray-100 sm:justify-center dark:text-gray-800">
                ...
                <Link to={'offlineBest'} onClick={() => { setList(1) }} className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${list === 1 ? 'border border-b-0' : 'border-b'} rounded-t-lg dark:border-gray-600 dark:text-gray-900`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
